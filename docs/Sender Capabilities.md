...
This specification defines a `constraint_sets` attribute for the Sender `caps` object, its value is an array of alternatives; this constraint is satisfied when **any of** its enumerated Constraint Sets are satisfied.
